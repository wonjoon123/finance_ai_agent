...
# 오류 있을 수 있으니까 한 번 더 오류 체크 클로바한테
# def call_clova_error_check(user_input, api_key, request_id):
#     messages = [
#         {
#             "role": "system",
#             "content": pre_prompt.error_check
#         },
#         {"role": "user", "content": user_input}
#     ]
...
#         return result
#     else:
#         logger.error(f"call clova error check Error: {response.status_code} {response.text}")
#         return "call_clova에서 오류가 발생했습니다."
